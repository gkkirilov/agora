            ...
            <div class="text-4xl">
                <div>
                    ...
                    <div class="mx-auto mb-4 mt-16">
                        <NuxtLink to="/survey2"
                            class="inline-block rounded-md bg-gradient-to-tr from-indigo-400 to-indigo-700 px-3 py-2 text-xl font-extrabold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 uppercase">
                            {{ $t('finalSurvey.yes') }}
                        </NuxtLink>
                    </div>
                    <div class="mx-auto">
